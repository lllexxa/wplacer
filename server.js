...
class WPlacer {
  constructor(template, coords, settings, templateName, paintTransparentPixels = false, skipPaintedPixels = false, initialBurstSeeds = null) {
  ...
  async start() {
    ...
    try {
        ...
        if (useParallel) {
          ...
          const worker = async () => {
            for (;;) {
              ...
              const w = new WPlacer(this.template, this.coords, currentSettings, this.name, this.paintTransparentPixels, this.skipPaintedPixels, this.burstSeeds);
              try {
      ...
      while (this.running) {
        ...
        if (needFreshSummary) {
          const checkWplacer = new WPlacer(this.template, this.coords, currentSettings, this.name, this.paintTransparentPixels, this.skipPaintedPixels, this.burstSeeds);
          try {
        ...
        if (foundUserForTurn) {
          ...
          const wplacer = new WPlacer(this.template, this.coords, currentSettings, this.name, this.paintTransparentPixels, this.skipPaintedPixels, this.burstSeeds);
          ...
          if (this.canBuyCharges && !activeBrowserUsers.has(this.masterId)) {
            ...
            const chargeBuyer = new WPlacer(this.template, this.coords, currentSettings, this.name, this.paintTransparentPixels, this.skipPaintedPixels, this.burstSeeds);
            try {
